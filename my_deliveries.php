...
// Get deliveries assigned to this logistics provider
$sql = "SELECT o.*, 
        c.crop_name,
...
foreach($deliveries as $d) {
    if ($d['order_status'] == 'in_transit') $in_transit++;
    if ($d['order_status'] == 'delivered') $delivered++;
}
?>
...
<head>
    <title><?php echo t('my_deliveries'); ?> - Soko Fresh</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; }
        ...
        .stat-item.purple .number { color: #6a1b9a; }
...
<body>
    ...
    <div class="container">
        ...
        <div class="page-title">
            <h1><i class="fas fa-list"></i> <?php echo t('my_deliveries'); ?></h1>
            <span class="badge"><?php echo count($deliveries); ?> <?php echo t('total'); ?></span>
        </div>
        ...
        <?php if(count($deliveries) > 0): ?>
            <div class="stats-row">
                <div class="stat-item purple">
                    ...
                    <div class="label"><i class="fas fa-truck"></i> <?php echo t('in_transit'); ?></div>
                </div>
                <div class="stat-item green">
                    <div class="number"><?php echo $delivered; ?></div>
                    <div class="label"><i class="fas fa-check-circle"></i> <?php echo t('delivered'); ?></div>
                </div>
            </div>
                ...
                <div class="delivery-card">
                    <div style="display:flex; justify-content:space-between; align-items:center;">
                        <span class="crop-name">
                            <?php 
                            $crop_name = $delivery['crop_name_display'];
                            if ($current_lang == 'sw' && isset($crop_translations[$crop_name])) {
                                echo $crop_translations[$crop_name];
                            } else {
                                echo htmlspecialchars($crop_name);
                            }
                            ?>
                        </span>
                    ...
                    <?php if($delivery['order_status'] == 'in_transit'): ?>
                    ...
                    <?php elseif($delivery['order_status'] == 'delivered'): ?>
                        <div class="delivered-label">
                            <i class="fas fa-check-circle"></i> <?php echo t('delivered_success'); ?>
                        </div>
                    <?php endif; ?>
                </div>
                <?php endforeach; ?>
        ...
        <?php else: ?>
            <div class="empty-state">
                ...
                <h3><?php echo t('no_deliveries_yet'); ?></h3>
                <p><?php echo t('no_deliveries_yet_msg'); ?></p>
                <p style="margin-top:10px;"><a href="available_deliveries.php" style="color:#2e7d32; font-weight:bold;"><?php echo t('view_available_deliveries'); ?> →</a></p>
            </div>
        <?php endif; ?>
